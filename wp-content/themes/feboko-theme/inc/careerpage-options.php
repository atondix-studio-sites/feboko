...
class FeBoKo_Careerpage_Options
{

  private $option_name = 'feboko_careerpage_options';
  ...
  public function __construct()
  {
    ...
    add_filter('option_page_capability_feboko_careerpage_group', function () {
      return 'edit_pages';
    });
  }
  ...
  {
    if ($hook !== 'toplevel_page_feboko-careerpage-settings') {
      return;
    }
    ...
    ?>
        ...
        <div class="wrap">
          ...
          <form method="post" action="options.php">
            <?php settings_fields('feboko_careerpage_group'); ?>

            <h2>About Section</h2>
            <p>The "About Us" block displayed on the career page.</p>
            ...
            <h2>Initiative Application Section</h2>
            <p>The "Initiativbewerbung" CTA block below the about section.</p>
            <?php $this->field($options, 'initiative', 'subtitle', 'Subtitle'); ?>
            <?php $this->field($options, 'initiative', 'title', 'Title'); ?>
            <?php $this->field($options, 'initiative', 'text', 'Description', true); ?>
            <?php $this->field($options, 'initiative', 'cta', 'Button Text'); ?>
            <?php $this->field($options, 'initiative', 'cta_link', 'Button Link (e.g. mailto:... or #contact)'); ?>
